...
namespace SPA
{
    class Supplier_Spa
    {
        ...
        public void SaveSupplier()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("addSpa_Supplier", sqlcon);
        ...
        public DataTable SupplierView()
        {
            ...
            SqlDataAdapter dataAdapter = new SqlDataAdapter("veiwSearchSupplier", sqlcon);
        ...
        {
            DBConnection.openDBConnection();
            SqlCommand sqlCommand = new SqlCommand("editSupplier", sqlcon);
            sqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        {
            DBConnection.openDBConnection();
            SqlCommand sqlCommand = new SqlCommand("deleteSupplier", sqlcon);
            sqlCommand.CommandType = CommandType.StoredProcedure;
